/**
 * Asks user for their height and weight then converts this information into kg and m to calculate their BMI
 * @author Ona
 * @version 11/16/22
 */
...
public class BMICalculator {
     ...
     * @param pounds user's weight in pounts
     * @return BMI expressed as weight(kg)/height(m)^2 a double
     */
